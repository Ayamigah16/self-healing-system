################################################################################
# Networking Module
# VPC · Public/Private Subnets · IGW · NAT Gateways · Security Groups
################################################################################
...
resource "aws_security_group" "ec2" {
  ...
  description = "Allow inbound traffic from ALB to EC2 web servers"
  vpc_id      = aws_vpc.main.id
...
# VPC Flow Logs for security observability
